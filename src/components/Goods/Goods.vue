<template>
  <div class='goods'>
            ...
            <li v-for='(food,index) in item.foods' :key='index' @click='selectFood(food,$event)' class='food-item border-1px'>
              ...
              <div class='content'>
                ...
                <div class='cartcontrol-wrapper'>
                  <v-cartcontrol :food='food' v-on:cart-add='_drop'></v-cartcontrol>
                </div>
              </div>
            </li>
          </ul>
    ...
    <v-shopcart :delivery-price='seller.deliveryPrice' :min-price='seller.minPrice' :selectFoods='selectFoods' ref='shopcart'></v-shopcart>
